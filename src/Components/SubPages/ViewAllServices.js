    ...
    <div className="container">
      ...
      >
        <div
          style={{
            overflow: "auto",
            maxHeight: "auto", // Adjust maxHeight as needed
        ...
        >
          ...
          >
            {cards.slice(0, 100) // Limit the number of cards based on screen size
              .map((card) => (
                <Grid item xs={2} sm={4} md={4} key={card.title}>
                  <Card
                    style={{
                      ...
                      overflowX: "auto", // Add horizontal scrolling
                      backgroundImage: 'url("")', // Replace "your-image-url.jpg" with the actual image URL
                      backgroundSize: 'cover', // You can change
                      backgroundColor: "#f5f5f9", // Light gray background color
                      border: "2px solid orange", // Add a thin border
                    }}
                  >
                    <CardContent>
                    <CardMedia
